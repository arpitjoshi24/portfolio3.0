...
export default function Body() {
  ...
  return (
    <div >
      ...
      {/* About Section */}
      <section className="bg-primary md:h-screen text-secondary" >
  ...
  <div className="px-10 py-24">
    <Slider {...settings} className="container mx-auto">
      ...
      <div className='flex flex-col space-y-28'>
        {/* 1st */}
        <section data-aos="zoom-in-up" class="body-font shadow-xl shadow-purple-900 mx-4 md:mx-12">
  <div class="container mx-auto flex flex-col md:flex-row px-5 py-12 md:py-16 border-2 rounded-xl border-blue-900 items-center">
   
    <div class="lg:max-w-lg lg:w-full md:w-1/2 w-full mb-8 md:mb-0">
      <img class="object-cover object-center rounded border-2 border-black" alt="hero" src="/onestop.png" />
    </div>
    
  
    <div class="lg:flex-grow md:w-1/2 lg:pl-16 md:pl-10 flex flex-col md:items-start md:text-left items-center text-center">
      <h3 class="title-font sm:text-4xl text-3xl mb-4 font-bold text-tertiary">ONESTOP</h3>
      ...
      <div class="flex flex-wrap justify-center md:justify-start gap-4">
        <button class="inline-flex text-white bg-blue-900 border-0 py-2 px-4 rounded text-sm md:text-lg">HTML</button>
        <button class="inline-flex text-white bg-blue-900 border-0 py-2 px-4 rounded text-sm md:text-lg">CSS</button>
        <button class="inline-flex text-white bg-blue-900 border-0 py-2 px-4 rounded text-sm md:text-lg">JavaScript</button>
        <button class="inline-flex text-white bg-blue-900 border-0 py-2 px-4 rounded text-sm md:text-lg">React</button>
        <button class="inline-flex text-white bg-blue-900 border-0 py-2 px-4 rounded text-sm md:text-lg">MongoDB</button>
      </div>

     
      <div class="flex flex-wrap justify-center md:justify-start gap-4 my-6">
        <button class="inline-flex text-white bg-blue-900 border-0 py-2 px-4 rounded text-sm md:text-lg">Tailwind CSS</button>
        <button class="inline-flex text-white bg-blue-900 border-0 py-2 px-4 rounded text-sm md:text-lg">Node.js</button>
        <button class="inline-flex text-white bg-blue-900 border-0 py-2 px-4 rounded text-sm md:text-lg">Express.js</button>
      </div>
    </div>
  </div>
</section>
...
{/* 2nd */}
<section data-aos="zoom-in-up" class="body-font shadow-xl shadow-purple-900 mx-4 md:mx-12">
  <div class="container mx-auto flex flex-col md:flex-row px-5 py-16 md:py-20 border-2 rounded-xl border-blue-900 items-center">

    <div class="lg:flex-grow md:w-1/2 lg:pl-16 md:pl-12 flex flex-col md:items-start md:text-left items-center text-center">
      <h1 class="title-font sm:text-4xl text-3xl mb-4 font-bold text-tertiary">SIMON GAME</h1>
      <p class="mb-8 leading-relaxed text-sm md:text-base">
    ...
    <div class="lg:max-w-lg lg:w-full md:w-1/2 w-full mt-8 md:mt-0">
      <img class="object-cover object-center rounded border-2 border-black" alt="hero" src="/simon.png" />
    </div>
  </div>
</section>
...
{/* 3rd */}
<section data-aos="zoom-in-up" class="body-font shadow-xl shadow-purple-900 mx-4 md:mx-12">
  <div class="container mx-auto flex flex-col md:flex-row px-5 py-16 md:py-24 border-2 rounded-xl border-blue-900 items-center">
   
    <div class="lg:max-w-lg w-full md:w-1/2 mb-10 md:mb-0 border-2 border-black">
      <img class="object-cover object-center rounded" alt="SpyDown Screenshot" src="/spydown.png"/>
    </div>
    
   
    <div class="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-12 flex flex-col md:items-start md:text-left items-center text-center">
      <h1 class="title-font sm:text-4xl text-3xl mb-4 font-bold text-tertiary">SpyDown</h1>
      <p class="mb-8 leading-relaxed text-sm md:text-base">
      ...
      <ul class="flex flex-wrap justify-center md:justify-start gap-4">
        <li class="inline-flex text-white bg-blue-900 border-0 py-2 px-4 rounded text-sm md:text-lg">HTML</li>
        <li class="inline-flex text-white bg-blue-900 border-0 py-2 px-4 rounded text-sm md:text-lg">CSS</li>
        <li class="inline-flex text-white bg-blue-900 border-0 py-2 px-4 rounded text-sm md:text-lg">JavaScript</li>
        <li class="inline-flex text-white bg-blue-900 border-0 py-2 px-4 rounded text-sm md:text-lg">Tailwind CSS</li>
      </ul>
    </div>
  </div>
</section>
   ...
   {/* stay connected */}
   <section className='bg-primary text-secondary md:h-screen'>
  <h3 className="text-center text-2xl mx-4 md:mx-0 md:text-6xl pt-40 pb-36">STAY CONNECTED WITH ME</h3>

  <div className='flex justify-around'>
    {/* Instagram */}
    <div className="group relative inline-block w-1/2 lg:w-1/4 md:basis-0" data-aos="zoom-in-down">
...
>
  ...
  <span className="absolute -top-14 left-1/2 transform -translate-x-1/2 z-20 px-4 py-2 text-sm font-bold text-white bg-gray-900 rounded-lg shadow-lg transition-transform duration-300 ease-in-out scale-0 group-hover:scale-100">
    ...
    {/* discard */}
    <div className="group relative inline-block sm:w-1/2 lg:w-1/4 md:basis-0 " data-aos="zoom-in-down">
      <button className="focus:outline-none">
      <svg
  xmlns="http://www.w3.org/2000/svg"
  viewBox="0 0 640 512"
...
>
  <path d="M524.5 69.8a1.5 1.5 0 0 0 -.8-.7A485.1 485.1 0 0 0 404.1 32a1.8 1.8 0 0 0 -1.9 .9 337.5 337.5 0 0 0 -14.9 30.6 447.8 447.8 0 0 0 -134.4 0 309.5 309.5 0 0 0 -15.1-30.6 1.9 1.9 0 0 0 -1.9-.9A483.7 483.7 0 0 0 116.1 69.1a1.7 1.7 0 0 0 -.8 .7C39.1 183.7 18.2 294.7 28.4 404.4a2 2 0 0 0 .8 1.4A487.7 487.7 0 0 0 176 479.9a1.9 1.9 0 0 0 2.1-.7A348.2 348.2 0 0 0 208.1 430.4a1.9 1.9 0 0 0 -1-2.6 321.2 321.2 0 0 1 -45.9-21.9 1.9 1.9 0 0 1 -.2-3.1c3.1-2.3 6.2-4.7 9.1-7.1a1.8 1.8 0 0 1 1.9-.3c96.2 43.9 200.4 43.9 295.5 0a1.8 1.8 0 0 1 1.9 .2c2.9 2.4 6 4.9 9.1 7.2a1.9 1.9 0 0 1 -.2 3.1 301.4 301.4 0 0 1 -45.9 21.8 1.9 1.9 0 0 0 -1 2.6 391.1 391.1 0 0 0 30 48.8 1.9 1.9 0 0 0 2.1 .7A486 486 0 0 0 610.7 405.7a1.9 1.9 0 0 0 .8-1.4C623.7 277.6 590.9 167.5 524.5 69.8zM222.5 337.6c-29 0-52.8-26.6-52.8-59.2S193.1 219.1 222.5 219.1c29.7 0 53.3 26.8 52.8 59.2C275.3 311 251.9 337.6 222.5 337.6zm195.4 0c-29 0-52.8-26.6-52.8-59.2S388.4 219.1 417.9 219.1c29.7 0 53.3 26.8 52.8 59.2C470.7 311 447.5 337.6 417.9 337.6z" />
      ...
      <span className="absolute -top-14 left-1/2 transform -translate-x-1/2 z-20 px-4 py-2 text-sm font-bold text-white bg-gray-900 rounded-lg shadow-lg transition-transform duration-300 ease-in-out scale-0 group-hover:scale-100">Discord</span>
    </div>
  </div>
  {/* footer */}
  <section className='mt-16 md:mt-72 bg-[#061A34] h-24 flex items-center justify-center'>
    <footer class="bg-[#061A34] body-font ">
